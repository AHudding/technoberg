...
class EducationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create education" do
    assert_difference('Education.count') do
      post educations_url, params: { education: { dates: @education.dates, description: @education.description, institutionname: @education.institutionname, type: @education.type } }
    end
  ...
  test "should update education" do
    patch education_url(@education), params: { education: { dates: @education.dates, description: @education.description, institutionname: @education.institutionname, type: @education.type } }
